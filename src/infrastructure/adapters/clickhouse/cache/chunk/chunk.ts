...
import { IChunkData, IChunkOptions, IScratchChunkOptions } from './chunk.interfaces';
...
export class Chunk {
	...
	public get isOverfilled(): boolean {
		...
		return this._dataWatcher.countRows(this.id) >= this._dataWatcher._options.chunkSize;
	}
}
