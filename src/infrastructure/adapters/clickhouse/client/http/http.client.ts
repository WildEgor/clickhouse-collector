...
export class ClickhouseHttpClient {
	 ...
	 */
	constructor({ connectionOptions, clickhouseSettings = {} }: IClickhouseHttpClientProps) {
	...
	public async request<T>({
		...
		const response = await this._axiosInstance.request(config).catch((error: AxiosError) => {
